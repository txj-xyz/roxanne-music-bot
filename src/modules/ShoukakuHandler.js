...
class ShoukakuHandler extends Shoukaku {
    constructor(client) {
        ...
        this.on('ready', (name, resumed) => {
            ...
            client.webhook.send(`Lavalink Node: ${name} is now connected This connection is ${resumed ? 'resumed' : 'a new connection'}`);
        });
        ...
        this.on('close', (name, code, reason) => {
            ...
            client.webhook.send(`Lavalink Node: ${name} closed with code ${code} ${reason || 'No reason'}`);
        });
