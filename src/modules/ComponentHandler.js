...
class ComponentHandler extends EventEmitter {
    constructor(client) {
        ...
        this.client.logger.log(
            ...
            'Loaded ComponentEvent Listeners.'
        );
    ...
    async exec(interaction) {
        ...
        try {
            ...
            if (requestingUser.interaction.user.id !== interaction.user.id)
                return;
        } catch (error) {
        ...
        try {
            if (interaction.customId === 'playlist_menu') {
                await interaction.editReply({
                    content: 'Please wait, I am loading the query now. :)',
                    components: [],
                });
                    ...
                    case 'txb_playlist':
                        this.client.interactions.commands
                            ...
                            .buttonSpotifyPlaylist(
                                interaction,
                                'https://open.spotify.com/playlist/1Ac9XPXCQaTUjTNbnNwYhV'
                            );
                        break;
                    case 'txj_playlist':
                        this.client.interactions.commands
                            ...
                            .buttonSpotifyPlaylist(
                                interaction,
                                'https://open.spotify.com/playlist/4YLTXRl623J8WXYyZse3rk'
                            );
                        break;
                    case 'dnb_playlist':
                        this.client.interactions.commands
                            ...
                            .buttonYoutubePlaylist(
                                interaction,
                                'https://www.youtube.com/watch?v=RKSr5ovamds&list=PL9BCA60EEB1C8893D',
                                false
                            );
                        break;
                    case 'alda_playlist':
                        this.client.interactions.commands
                            ...
                            .buttonSpotifyPlaylist(
                                interaction,
                                'https://open.spotify.com/playlist/6CtQMssfXfWwUnAwZclC6b'
                            );
                        break;
                }
            } else if (interaction.customId === 'radio_menu') {
                await interaction.editReply({
                    content: 'Please wait, I am loading the radio station. :)',
                    components: [],
                });
                switch (interaction.values[0]) {
                    case 'lofi_radio':
