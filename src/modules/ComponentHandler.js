        ...
        try {
            ...
            if(interaction.customId === "playlist_menu"){
                ...
                switch (interaction.values[0]) {
                    case "txb_playlist":
                        this.play.playlistButtons(interaction, "https://open.spotify.com/playlist/1Ac9XPXCQaTUjTNbnNwYhV");
                        break;
                    case "txj_playlist":
                        this.play.playlistButtons(interaction, "https://open.spotify.com/playlist/4YLTXRl623J8WXYyZse3rk");
                        break;
                }
            }
        } catch (error) {
